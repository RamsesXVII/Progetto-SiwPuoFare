		...
		<header>
			<div class="header-content">
				<div class="header-content-inner">
					<h1>List of All CheapAndWeak customers</h1>
					<table>
						<tr>
							<th>LastName &nbsp</th>
							<th>Email &nbsp</th>
							<th>Password &nbsp</th>
							<th>RegistrationDate &nbsp</th>
							<th>State &nbsp</th></tr>
						...
						<c:forEach var="customer" items="#{customerController.customers}">
							<tr>
								...
								<td>${customer.email} &nbsp</td>
								<td>${customer.password} &nbsp</td>
								<td>${customer.registrationDate} &nbsp</td>
								<td>${customer.address.state} &nbsp</td>
							</tr>
						</c:forEach>
					</table>
				</div>
